// ================================================================
// D1 ADMIN SESSION AUTHENTICATION MIDDLEWARE
...
import { parseCookies } from '../handlers/auth.handler';
 ...
 */
export async function authenticateAdminSession(request: Request, env: Env): Promise<AuthenticatedUser> {

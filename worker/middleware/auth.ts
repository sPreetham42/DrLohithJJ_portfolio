// ================================================================
// CENTRAL ADMIN AUTHENTICATION DISPATCHER
// Feature-flagged dispatch between Cloudflare Access (default) and D1 Session auth
// ================================================================

import { Env, AuthenticatedUser } from '../types';
import { authenticateAdmin as authenticateAdminAccess } from './access';
import { authenticateAdminSession } from './session';
 ...
 */
export async function authenticateAdmin(request: Request, env: Env): Promise<AuthenticatedUser> {
